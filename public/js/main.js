...
},{"./dom/data.js":3,"./dom/event-handler.js":4,"./dom/selector-engine.js":6}],2:[function(require,module,exports){
/*!
...
},{"./base-component.js":1,"./dom/data.js":3,"./dom/event-handler.js":4,"./dom/manipulator.js":5,"./dom/selector-engine.js":6}],3:[function(require,module,exports){
/*!
...
var NavInfo = require("./modules/NavInfo");

NavInfo.init();

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./modules/NavInfo":10,"bootstrap/js/dist/collapse":2,"jquery":7,"simplebar":8}],10:[function(require,module,exports){
"use strict";
...
var NavInfo = {
  ...
  handleTabClick: function handleTabClick(e) {
    ...
    $(".nav-info__tabs__item", this.$root).removeClass("active").eq(index).addClass("active");
    $(".nav-info__group", this.$root).removeClass("active").eq(index).addClass("active");
  },
  init: function init() {
    if (!$("#nav-info").length) return;
    this.$root = $("#nav-info");
    $(document).on("click", ".nav-info__tabs__item", this.handleTabClick.bind(this));
  }
};
